...
export default function SeriesCard({
  ...
  const existingPrediction = React.useMemo(() => {
    ...
    return predictions.find(
      (p) => p.series_id === series.series_id && p.user_email === user.email,
    );
  ...
  React.useEffect(() => {
    if (existingPrediction) {
      setPredictionData({
        ...
        games: existingPrediction.games
          ? existingPrediction.games.toString()
          : "",
      });
    }
  }, [existingPrediction]);
  ...
  const makeNewPrediction = async () => {
    if (!predictionData.winner || (!predictionData.games && !isPlayIn) || !user)
      return;
      ...
      <CardHeader className="pb-2 py-3 px-3 sm:py-4 sm:px-6">
        <CardTitle className="text-base sm:text-lg flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            />
            <span>
              {series.conference && series.conference !== "Finals"
                ? `${series.conference} · `
                : ""}
              {series.round
                .split("_")
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <div className="space-y-2 sm:space-y-3">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              {/* Series win count */}
              {!isPlayIn &&
                (series.team1_wins > 0 || series.team2_wins > 0) && (
                  <span
            ...
            <div className="surface-status-danger p-2.5 sm:p-3 rounded-lg border">
              ...
              <div className="flex items-center justify-center gap-4 mt-1.5">
                ...
                <div className="text-center">
                  ...
                  <div className="text-xl font-bold">
                    {currentGame.visitor_team_score || 0}
                  </div>
                </div>
              </div>
            </div>
                  ...
                  {h2hLoading ? (
                    ...
                    <div className="space-y-3">
                      <div className="surface-status-info flex justify-between items-center px-4 py-2 rounded-lg border">
                        <div className="text-center">
                          <div className="text-status-info-strong font-bold text-lg">
                            {h2hData.team1Wins}
                          </div>
                          <div className="text-status-info text-[10px] uppercase tracking-wider font-semibold">
          ...
          <div className="text-xs sm:text-sm text-gray-500">
            {isPlayIn
              ...
              : `Points: ${
                  ROUND_POINTS_DISPLAY[series.round]
          ...
          {canPredict ? (
            <div className="space-y-3">
              <Select
                ...
                onValueChange={(value) =>
                  setPredictionData((prev) => ({ ...prev, winner: value }))
                }
              ...
              {!isPlayIn && (
                <Select
                  ...
                  onValueChange={(value) =>
                    setPredictionData((prev) => ({ ...prev, games: value }))
                  }
                  disabled={isSubmitting}
                >
                  <SelectTrigger>
            ...
            <div className="text-sm text-gray-500 italic">
              {!user
                ...
                : isDeadlinePassed
                  ? "Predictions are closed for this series"
